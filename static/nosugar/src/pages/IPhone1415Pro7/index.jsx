...
export default function IPhone1415Pro7Page() {
  ...
  return (
    <>
      ...
      <Heading size="heading2xl" as="h1" className="mt-0 md:text-3xl sm:text-[28px]">
          Успешно!
        </Heading>
        {orderId && (
          <QRCode
        ...
        <Button  onClick={() => navigate('/iphone1415pro1')} size="sm" shape="round" className="mt-[20px] min-w-[83px] lg:text-[13px]" style={{ backgroundColor: '#CEE2B7', color: 'black', zIndex:'2' }}>
          На главную
        </Button>
      </div>
    </>
